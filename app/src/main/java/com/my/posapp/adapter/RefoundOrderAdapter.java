...
public class RefoundOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RefoundOrderAdapter(Context context, ArrayList<PaymentModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itme_refound, viewGroup, false);
