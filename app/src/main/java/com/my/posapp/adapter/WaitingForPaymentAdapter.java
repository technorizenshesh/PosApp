...
public class WaitingForPaymentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public WaitingForPaymentAdapter(Context context, ArrayList<PaymentModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itme_waiting_payment, viewGroup, false);
