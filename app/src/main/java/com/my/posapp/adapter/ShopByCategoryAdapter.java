...
public class ShopByCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ShopByCategoryAdapter(Context context, ArrayList<PaymentModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itme_shop_by_category, viewGroup, false);
