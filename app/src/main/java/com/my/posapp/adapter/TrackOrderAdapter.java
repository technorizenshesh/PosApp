...
public class TrackOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public TrackOrderAdapter(Context context, ArrayList<PaymentModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_track_order, viewGroup, false);
